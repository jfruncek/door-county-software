...
{	
    private static final long serialVersionUID = 4522638678137405788L;
			...
			if (importFile != null) 
			{
				...
				{					 
					...
					{		
						...
						if (report.getReportChart() != null)
						{
							...
							if (chart == null)
							{
								...
								if (report.getReportChart().getDrillDownReport() != null)
								{
									...
									{						
										drillDownReport = reportProvider.insertReport(report.getReportChart().getDrillDownReport(), getUser().getName());
						...
						if (report.getParameters() != null)
						{
							...
							{								
								...
								if (parameter == null)
								{
									...
									parameter = parameterProvider.insertReportParameter(map.getReportParameter(), getUser().getName());
						...
						reportProvider.insertReport(report,getUser().getName());
