...
public class DeleteBookAction extends DeleteAction 
{	
	private static final long serialVersionUID = -3084169070517310130L;
	...
	{	
		try
		{
			ReportBook reportBook =
				bookProvider.getReportBook(new Integer(id));
			...
			if (submitDelete)
			{
				bookProvider.deleteReportBook(reportBook);
			}
		}
		catch (Exception e)
		{
