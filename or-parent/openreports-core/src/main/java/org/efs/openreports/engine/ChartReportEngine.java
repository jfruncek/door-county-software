...
public class ChartReportEngine extends ReportEngine
{
	 ...
	 */
	public ChartValue[] getChartValues(ReportChart reportChart, Map<String, Object> parameters)
			throws ProviderException
	{
	...
	private ChartEngineOutput createChartOutput(ReportChart reportChart, ChartValue[] values, boolean displayInline, Map<String, Object> parameters)
	{
		...
		chartOutput.getContentManager().write(image);	
	...
	private JFreeChart createOverlayChart(ReportChart reportChart, ChartValue[] values, boolean displayInline, Map<String,Object> parameters)
	{
