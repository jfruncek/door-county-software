...
import org.efs.openreports.scheduler.ReportRunData;

public class ReportLog  implements Serializable, ReportRunData
{	
    ...
    public List<? extends ReportDeliveryData> getDeliveryDatas()
    {
        return deliveryLogs;
    }
	...
	public boolean isSuccess() {
	    return ReportLog.STATUS_SUCCESS.equals( getStatus() );
	}
