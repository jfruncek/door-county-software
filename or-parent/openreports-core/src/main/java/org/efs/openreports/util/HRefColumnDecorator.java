...
{		
	...
	{
		return textProvider.getText(LocalStrings.LINK_BOOKS);	
	}	
	
	public Object getChaptersLink()
	{
		return textProvider.getText(LocalStrings.LINK_CHAPTERS);	
	}	

	public Object getRunBookLink()
	{
		return textProvider.getText(LocalStrings.LINK_RUN_BOOK);	
	}	
}
