 ...
 * 
 * TODO:
 * mconner: Actually, the ONLY usage appears to be in ParameterProvider, where it hides the fact
 * that the value is an array. However, for some items it should be an array, but for others, if 
 * it there is more than one value, that would be an error.  This is just really confusing and
 * it should be eliminated.  UPDATE: It has been eliminated. Will get rid of this class after some more testing
 * 
 * 
 *
 * @see ParameterAware
...
{  
   ...
   {
       Object mObject = m.get(key);
      Object[] value = (Object[]) mObject;
