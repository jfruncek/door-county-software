...
<div align="center" >
  ...
  <div id="editReportTabs" class="yui-navset" style="width: 90%;">
    <ul class="yui-nav">
    ...
    <div class="yui-content" >
      ...
      <table class="dialog">    
        ...
        <tr class="b">
          ...
          <td><input type="text" size="60" name="description" value="<s:property value="report.description"/>"></td>
        </tr>     
        <tr class="a">
          <td class="boldText"><s:text name="Documentation Link"/></td>
          <td>
          	&nbsp;
          </td>
          <td><input type="text" size="60" name="docUrl" value="<s:property value="report.docUrl"/>"></td>
        </tr> 
        <tr class="b">
          <td class="boldText"><s:text name="Last Modified By"/></td>
          <td>
          	&nbsp;
          </td>
          <td><s:property value="report.ctrlUser"/></td>
        </tr>
        <tr class="b">
          <td class="boldText"><s:text name="Last Modified On"/></td>
          <td>
          	&nbsp;
          </td>
          <td><s:property value="report.ctrlDate"/></td>
        </tr>
        <tr>
        ...
        <tr class="b">
          <td class="boldText"><s:text name="Notes"/></td>
          <td>
          	&nbsp;
          </td>
          <td><textarea rows="2" cols="130" style="font-size: smaller;" name="notes"><s:property value="notes"/></textarea>
        </tr> 
        <tr class="a">
        ...
        <tr>
          ...
          <td>  	   
            <textarea rows="21" cols="130" style="font-size: smaller;" name="query"><s:property value="query"/></textarea>
          </td>
        </tr>     
        <tr class="a">
        ...
        <s:if test="report.buildParametersListImplemented">
        <tr class="a">
