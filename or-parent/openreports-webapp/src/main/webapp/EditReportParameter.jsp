...
<div align="center">   
  ...
  <table class="dialog" >   
    ...
    <tr class="b">
      ...
      <td>
      	<s:property value="reportParameter.ctrlUser"/>
      </td>
    </tr>
    <tr class="b">
      ...
      <td>
      	<s:property value="reportParameter.ctrlDate"/>
      </td>
    </tr>
    <tr class="a">
  ...
  <table class="dialog" >
  	...
  	<tr class="b">
      <s:if test="className.equals('java.util.Date') || className.equals('java.sql.Date')">   
        <td><s:date name="id" format="dd/MM/yyyy" /></td>
      </s:if>
      <s:else>
