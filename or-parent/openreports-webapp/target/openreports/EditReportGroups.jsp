...
<div align="center">   
  ...
  <div class="filterLabel-dialog" align="left" >
    <script type="text/javascript">
      addLoadEvent(function() { setCheckableItemFilterFromCookie("EditReportGroupsTable", 0); });
    </script>
    <form name="filterForm" class="instructions"><span class="filterLabel">Filter:</span>
      <input name="filter" onkeyup="filterCheckableItemTable(this.value, 'EditReportGroupsTable', 0)"
        type="text"/>&nbsp;<span id="EditReportGroupsTableFilterInfo"></span>
    </form>
  </div>
  ...
  <table id="EditReportGroupsTable" class="dialog">
