...
public interface SchedulerProvider
{
	...
	public ReportSchedule getScheduledReport(String jobGroup, String name)
	...
	public void deleteScheduledReport(String jobGroup, String name)
			throws ProviderException;

	public void pauseScheduledReport(String jobGroup, String name)
			throws ProviderException;

	public void resumeScheduledReport(String jobGroup, String name)
			throws ProviderException;

    public boolean isPaused( String jobGroup, String scheduleName )
            throws ProviderException;
}