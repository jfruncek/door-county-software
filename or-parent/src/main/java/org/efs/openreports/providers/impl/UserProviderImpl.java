...
public class UserProviderImpl implements UserProvider
{
	...
	public ReportUser insertUser(ReportUser user, String updateUser) throws ProviderException
	{
		return (ReportUser) hibernateProvider.saveCtrlDataObject(user, updateUser);
	}

	public void updateUser(ReportUser user, String updateUser) throws ProviderException
	{
		hibernateProvider.updateCtrlDataObject(user, updateUser);
	}
