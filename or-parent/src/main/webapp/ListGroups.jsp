...
<div align="center">
  ...
  <div class="filterLabel" align="left" >
    <script type="text/javascript">
      addLoadEvent(function() { setFilterFromCookie("ListGroupsTable", 0); });
    </script>
    <form name="filterForm" class="instructions"><span class="filterLabel">Filter:</span>
      <input name="filter" onkeyup="filterTable(this.value, 'ListGroupsTable', 0)"
        type="text"/>&nbsp;<span id="ListGroupsTableFilterInfo"></span>
    </form>
  </div>
  
  <display:table id="ListGroupsTable" name="reportGroups" class="displayTag" sort="list" requestURI="listGroups.action" decorator="org.efs.openreports.util.HRefColumnDecorator"> 	      
    ...
    <display:column property="booksLink" title="" href="editGroupBooks.action" paramId="id" paramProperty="id"/>  	     	         	     
