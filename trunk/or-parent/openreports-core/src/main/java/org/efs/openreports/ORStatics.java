...
public class ORStatics
{
	...
	public static final String OPERREPORTS_PARAM_PREFIX = "OPENREPORTS_";
	...
	// book report parameter names
    public static final String BASE_OUTPUT_PATH = "OPENREPORTS_BASE_OUTPUT_PATH";
    /** Set for reports participating in a larger report run and tracked by a ReportRun. */
    public static final String REPORT_RUN_REFERERENCE_KEY = "OPENREPORTS_REPORT_RUN_REFERENCE_KEY";

    // Parameters used by batch
    /** MailMessage.EMAIL_SEPARATORS separated list of  email addresses */
    public static final String NOTIFICATION_EMAIL_ADDRESSES = "OPENREPORTS_NOTIFICATION_EMAIL_ADDRESSES";
	...
	public static final String BOOK_ADMIN_ROLE = "BOOK_ADMIN_ROLE";
	...
	public static final String[] ADMIN_ROLES = new String[] { ROOT_ADMIN_ROLE,
			...
			SCHEDULER_ADMIN_ROLE, BOOK_ADMIN_ROLE };
	
	// parameter name suffix (used by more than one action)
	public static final String LOCK = "_lock";
	
	public static final String[] BOOK_PROVIDED_PARAMETERS = new String[] {
	    BASE_OUTPUT_PATH,
	    REPORT_RUN_REFERERENCE_KEY
	};
	
	public static boolean isBookProvidedParameter( String parameterName ) {
	    return ArrayUtils.contains( BOOK_PROVIDED_PARAMETERS, parameterName ); 
    }
}
