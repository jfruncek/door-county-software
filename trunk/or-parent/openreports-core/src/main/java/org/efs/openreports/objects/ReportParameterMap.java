...
/**
 * A relationship between Report and a ReportParameter. 
 * In spite of the name, it is closer to a Map.Entry than a Map, and would be better named "ReportToParameterRelation". 
 */
