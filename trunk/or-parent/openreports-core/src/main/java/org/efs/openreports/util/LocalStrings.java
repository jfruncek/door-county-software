...
public class LocalStrings
{
	...
	public static final String ERROR_OUTPUTPATH_REQUIRED = "error.outputpath.required";
	...
	public static final String ERROR_REPORT_NAME_BLANK = "error.reportname.blank";
	public static final String ERROR_REPORT_QUERY_BLANK = "error.reportquery.blank";
	public static final String ERROR_REPORT_QUERY_INVALID = "error.reportquery.invalid";
	public static final String ERROR_REPORT_QUERY_PARAMETERS = "error.reportquery.parameters";
	public static final String ERROR_REPORTGROUP_NOTAUTHORIZED = "error.reportgroup.notauthorized";
    public static final String ERROR_REPORT_NOT_GROUP_MEMBER = "error.report.notgroupmember";
    ...
    public static final String ERROR_NO_DELIVERY_METHOD = "error.no.delivery.method";
	...
	public static final String ERROR_BOOK_DELETION = "error.book.deletion";
	public static final String ERROR_BOOK_INVALID = "error.book.invalid";
	public static final String ERROR_BOOK_GROUP_REQUIRED = "error.book.group.required";
    ...
    public static final String LINK_BOOKS = "link.books";
    public static final String LINK_CHAPTERS = "link.chapters";
    public static final String LINK_RUN_BOOK = "link.runBook";
