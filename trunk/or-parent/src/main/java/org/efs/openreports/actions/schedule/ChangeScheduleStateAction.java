	...
	public String execute()
	{
		try
		{
			...
			ReportSchedule reportSchedule =
				schedulerProvider.getScheduledReport(reportUser.getId().toString(), scheduleName);
			...
			if (submitOk)
			{
				...
				{
					schedulerProvider.pauseScheduledReport(reportUser.getId().toString(), scheduleName);
				}
				
				if (scheduleState.equals("Paused"))
				{
					schedulerProvider.resumeScheduledReport(reportUser.getId().toString(), scheduleName);
				}
			}
		}
		catch (Exception e)
