...
public class JasperReportEngine extends ReportEngine
{
	...
	{		
		ReportEngineOutput engineOutput = new ReportEngineOutput();
		...
		try
		{
			...
			exporter.setParameter(JRExporterParameter.OUTPUT_STREAM, engineOutput.getContentManager());
		...
		engineOutput.getSupplementaryContent().put(ORStatics.IMAGES_MAP, imagesMap);
