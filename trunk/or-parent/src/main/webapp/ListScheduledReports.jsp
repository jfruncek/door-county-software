...
<html>
<head>
<title><s:property value="getText('application.title')" /> - Scheduled Reports</title>
</head>
</html>
...
<div align="center">
  ...
  <div class="filterLabel" align="left" >
    <script type="text/javascript">
      addLoadEvent(function() { setFilterFromCookie("ListScheduledReportsTable", 1); });
    </script>
    <form name="filterForm" class="instructions"><span class="filterLabel">Filter by Description:</span>
      <input name="filter" onkeyup="filterTable(this.value, 'ListScheduledReportsTable', 1)"
        type="text"/>&nbsp;<span id="ListScheduledReportsTableFilterInfo"></span>
    </form>
  </div>
  
  
  
  <display:table id="ListScheduledReportsTable" name="scheduledReports" class="displayTag" sort="list" decorator="org.efs.openreports.util.HRefColumnDecorator" requestURI="listScheduledReports.action" >         
